...
public class BounceWeaponController : WeaponController
{
    ...
    public override Skill[] getWeaponSkills()
    {
        return new Skill[]{
            ...
            new LevelingSkill("Damage Bigger Weapon", 11, "Bounce Weapon",this.sprite,this),
            new LevelingSkill("AttackSpeed Bigger Weapon", 12, "Bounce Weapon",this.sprite, this),
            new LevelingSkill("Projectil Speed Bounce Weapon", 15, "Damage Bounce Weapon",this.sprite, this),
