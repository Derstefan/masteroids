...
public class GranadeProjectileController : ProjectileController
{

    public float explosionScale = 18f;
    ...
    private void Update()
    {
        ...
        {
            // Scale up the circle
            transform.localScale = Vector3.Lerp(Vector3.one, Vector3.one * explosionScale, progress);
    ...
    public override void Explode()
    {
        ...
        foreach (Collider2D hit in colliders)
        {
            ...
            if (hitRb != null)
            {
                Utils.AddExplosionForce(hitRb, explForce, transform.position, explosionRadius, 0.0F, ForceMode2D.Impulse);
            }
