...
public class ImplosionWeaponController : WeaponController
{
    ...
    {
        return new Skill[]{
            new UnlockSkill("Implosion Granade", 20,null,this),
            new LevelingSkill("Implosion Granade Damage", 21, "Implosion Granade", this),
            new LevelingSkill("Implosion Granade Explosion Radius", 22, "Implosion Granade", this),
            new LevelingSkill("Implosion Granade AttackSpeed", 23, "Implosion Granade", this)
        };
    }
